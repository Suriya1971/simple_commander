...
if __name__ == '__main__': 
    ...
    result = movebase_client(0.81, 11.1, 180.0)

    rospy.sleep(5)

    result = movebase_client(-7.2, 11.1, -90.0)

    rospy.sleep(5)

    result = movebase_client(-7.2, 5.0, 0.0)

    rospy.sleep(5)

    result = movebase_client(0.81, 5.0, 90.0)
